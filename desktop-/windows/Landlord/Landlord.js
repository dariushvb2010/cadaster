    ...
    AllData : function(){
        ...
        var addToShopBtn =Ext.create('Ext.Button', {
            ...
            handler: function() {
                ...
                plateCode.plateCode = segmentGridPanel.getSelectionModel().getSelection()[0].data.PlateCode;
        ...
        var segmentGridPanel = Ext.create('Ext.grid.GridPanel', {
            ...
            columns: [
                ...
                { text: 'کد',  dataIndex: 'PlateCode', width: 60, field: {xtype: 'textfield'}, sortable: true, menuDisabled: true, align: 'center'},
