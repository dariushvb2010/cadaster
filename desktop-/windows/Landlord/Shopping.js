    ...
    AllData : function(){
        ...
        var gridPanel = Ext.create('Ext.grid.Panel', {
            ...
            columns: {
                ...
                items: [{ text: 'ردیف',  dataIndex: 'LinkCode', width: 60, align: 'center',height: 30, filter: {type: 'int',minValue: 1} },
        ...
        //
        //index.php?r=business/usersList
        //
            ...
            buttons: [{
                ...
                handler: function(){
                    this.up('form').getForm().submit({
                        url: 'index.php?r=business/buyLand',
                        params: plateCode,
                        ...
                        failure: function(form, action) {
                            Ext.Msg.alert('Failed', "not recived, OK");
                        }
                    });
                }
            }]
