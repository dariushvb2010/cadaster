        ...
        var gridPanel = Ext.create('Ext.grid.Panel', {
            ...
            columns: {
                ...
                items: [
                    ...
                    { text: 'قیمت پیشنهادی',  dataIndex: 'suggestPrice', width: 60, align: 'center',height: 30, filter: true },
                    { text: 'قیمت نهایی',  dataIndex: 'finalPrice', width: 60, align: 'center',height: 30, filter: true },
                    { text: 'وضعیت', dataIndex: 'state', width: 150, field: {xtype: 'textfield'}, align: 'center', filter: true },
                    { text: 'تاریخ پیشنهاد', dataIndex: 'suggestDate', width: 150, field: {xtype: 'textfield'}, align: 'center', filter: true },
                    { text: 'تاریخ خرید', dataIndex: 'buyDate', width: 220, field: {xtype: 'textfield'}, align: 'center', filter: true },
