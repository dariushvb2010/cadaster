...
Ext.define('MyDesktop.Landlord.AddSegment', {
    ...
    getFieldForm: function(win){
        ...
        var form = Ext.widget('form', {
            width: 200,
            region: 'north',
            items: [usingType, numAdjacent, position, plantType, waterType, gridPanel],
    ...
    window: function(myThis){
        ...
        var myPolygonFormPanel = new me.PolygonFieldForm(this);
        ...
        if(!win){
            ...
            var panel = Ext.create('Ext.Panel', {
                layout: 'border',
                items: [myMapPanel.getPanel(), myPolygonFormPanel.getForm(), fieldFormPanel]
            });
