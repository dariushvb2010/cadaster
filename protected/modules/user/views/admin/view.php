...
$this->menu=array(
    ...
    array('label'=>UserModule::t('Update User'), 'url'=>array('update','id'=>$model->id),'linkOptions'=>array('class'=>'item')),
    array('label'=>UserModule::t('Delete User'), 'url'=>'#','linkOptions'=>array('class'=>'item','submit'=>array('delete','id'=>$model->id),'confirm'=>UserModule::t('Are you sure to delete this item?'))),
