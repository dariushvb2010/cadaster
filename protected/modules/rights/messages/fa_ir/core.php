...
return array (
  ...
  'Authorization items can be managed under {roleLink}, {taskLink} and {operationLink}.' => 'برای مدیریت عناصر تصدیق هویت به مسیرهای {roleLink}, {taskLink} و {operationLink} مراجعه کنید.',
