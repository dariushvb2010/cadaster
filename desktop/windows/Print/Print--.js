...
Ext.application({
    ...
    geo: function (obj, region){
        ...
        */
        ...
        var segmentPanel = Ext.create('Ext.panel.Panel', {
            ...
            resizable: true,
            border: 0,
            items: [rightSegmentPanel, leftSegmentPanel, inSegmentPanel]
        });
    ...
    launch: function(){
        var postData = {userId:window.opener.params.userId}; //insert your data to post here
        //a = window.opener.params;
        var rootThis = this;
